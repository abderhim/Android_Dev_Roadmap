...
object LearningDataSource {
    ...
    private fun buildTopics(): List<Topic> = listOf(
    ...
    // ─────────────────────────────────────────────
    private fun buildComposeFoundationsTopic() = Topic(
...
fun TimerScreen(durationSeconds: Int) {
    ...
    // ─────────────────────────────────────────────
    private fun buildAdvancedComposeTopic() = Topic(
        id = "advanced_compose",
    ...
    Card(
        ...
        Text(
            ...
            modifier = Modifier.padding(16.dp)
                ...
                questions = listOf(
                    Question(
                        id = "q_ac1_1", lessonId = "adv_compose_1",
                    ...
                    Question(
                        id = "q_ac1_2", lessonId = "adv_compose_1",
    ...
    NavHost(navController, startDestination = Screen.HOME) {
        ...
        composable(
            ...
            TopicScreen(
                ...
                questions = listOf(
                    Question(
                        id = "q_ac2_1", lessonId = "adv_compose_2",
                    ...
                    Question(
                        id = "q_ac2_2", lessonId = "adv_compose_2",
...
fun TopicListScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        AnimatedVisibility(
            ...
            FloatingActionButton(onClick = { /* scroll to top */ }) {
                ...
                questions = listOf(
                    Question(
                        id = "q_ac3_1", lessonId = "adv_compose_3",
                    ...
                    Question(
                        id = "q_ac3_2", lessonId = "adv_compose_3",
    ...
    // ─────────────────────────────────────────────
    private fun buildCoroutinesTopic() = Topic(
        id = "coroutines",
...
sealed interface UserUiState {
    ...
    data class Error(val message: String) : UserUiState
                ...
                questions = listOf(
                    Question(
                        id = "q_co1_1", lessonId = "coroutines_1",
                    ...
                    Question(
                        id = "q_co1_2", lessonId = "coroutines_1",
                    ...
                    Question(
                        id = "q_co1_3", lessonId = "coroutines_1",
    ...
    fun loadImage(url: String) {
        viewModelScope.launch {  // starts on Main
            ...
            // After suspension: automatically back on Main to update StateFlow
                ...
                questions = listOf(
                    Question(
                        id = "q_co2_1", lessonId = "coroutines_2",
                    ...
                    Question(
                        id = "q_co2_2", lessonId = "coroutines_2",
    ...
    fun loadWithFallback() {
        viewModelScope.launch {
            ...
            _state.value = DataState.Success(DataResult(primaryData, null))
                ...
                questions = listOf(
                    Question(
                        id = "q_co3_1", lessonId = "coroutines_3",
                    ...
                    Question(
                        id = "q_co3_2", lessonId = "coroutines_3",
...
class ProductViewModel(private val repo: ProductRepository) : ViewModel() {
    ...
    fun loadProduct(id: String) {
        viewModelScope.launch {
            ...
            safeCall { repo.getProduct(id) }
                ...
                questions = listOf(
                    Question(
                        id = "q_co4_1", lessonId = "coroutines_4",
                    ...
                    Question(
                        id = "q_co4_2", lessonId = "coroutines_4",
    ...
    // ─────────────────────────────────────────────
    private fun buildFlowsTopic() = Topic(
        id = "kotlin_flows",
        title = "Kotlin Flows",
...
class OrderViewModel(private val repo: OrderRepository) : ViewModel() {
    ...
    // ─────────────────────────────────────────────
    private fun buildCleanArchitectureTopic() = Topic(
...
class RegisterUserUseCase(
    ...
    // ─────────────────────────────────────────────
    private fun buildMvvmTopic() = Topic(
        id = "mvvm",
        title = "MVVM & UI State",
...
class ProfileViewModel(
    ...
    companion object {
        fun factory(container: AppContainer) = viewModelFactory {
            initializer {
                val app = this[APPLICATION_KEY] as LearnApp
                ProfileViewModel(
...
class TopicListViewModel(
    ...
    // ─────────────────────────────────────────────
    private fun buildDependencyInjectionTopic() = Topic(
...
fun UserScreen(vm: UserViewModel = hiltViewModel()) {
    ...
    // ─────────────────────────────────────────────
    private fun buildRoomDatabaseTopic() = Topic(
        id = "room_database",
        title = "Room Database",
